...
﻿# MJ-SECRETS — LE CREUSET

> ⛔ **JOUEUR : NE PAS LIRE. JAMAIS.** Ce fichier est le coffre du MJ.
> Toute session MJ le lit en silence au démarrage, ne le cite jamais, ne le paraphrase jamais.
> **Fixe** = jamais modifié, quoi qu'il arrive. **⟦SCELLE-6⟧** = rails indicatifs, le jeu décide.
> Les catastrophes/triomphes ferment et ouvrent des portes AUTOUR de ces points — jamais à leur place.
...
- Péché bureaucratique au cœur du système : on ne peut pas certifier un effacement sans trace. **Le « rôle des Rayés »** — l'unique copie écrite de tout ce que le monde a oublié — existe, scellé, au bureau central. L'effacement ⟦SCELLE-3⟧ le seul exemplaire. *(→ §6.)*
...
## 2 · LA BÊTE : **AUBRAN** *(fixe — nom définitif fixé et livré en scène le 2026-08-13, sc. 183 ; cf. errata §1.1)*

> **Le nom brûlé de 2026-08-10 reste interdit à jamais et ne désigne rien.** Partout où l'ancien mot apparaissait dans ce fichier, lire **Aubran**.

- Aubran est l'un des trois survivants : **le dieu de la Part du ⟦SCELLE-13⟧** — *ce que tu abats t'appartient*. Il a survécu parce que sa loi n'a jamais eu besoin qu'on y croie : la victoire a lieu, prière ou pas.
- Il s'est caché **dans la machine qui tue les dieux** : il porte la forme d'un familier. Le Masque de Seb n'est pas un pouvoir de Seb — **c'est Aubran qui ment au tableau d'affichage.** *(Confirmé et durci en v17 : il ment aux **instruments**, et il existe des instruments auxquels il ne ment pas — la pierre gravée du creux de la salle sèche a écrit 908 sur un Masque réglé à 900. Ne pas généraliser : cette pierre est d'avant la fermeture de la carrière.)*
- Nourriture : Seb encaisse 100 % de la puissance dévorée. Aubran, lui, se nourrit de **l'instant de victoire** — la seconde où le plus fort plie. **Livré en scène par Maud (sc. 149).** D'où sa personnalité : il s'allume à la reddition d'un homme qui avait quelque chose à perdre, **et reste éteint devant l'obéissance commandée** (vingt-quatre gamins à genoux : rien ; un maître déchu, front au pavé : tout).
...
- **ÉTAT AU PALIER II** : **elle a la taille exacte de Seb**, quinze motifs, **cinq mots** (« Part. » · « Après. » · « Creuset. » · « Suivant. » · « **Aubran.** » — sc. 183, dit en même temps que la bouche qui le chantait). Elle a mangé, sur Terre : le premier trophée de Victor, un garde, deux tenants, un maître de village, un maître de maison d'armes, un candidat de concours, un ancien du Verger, **Maud (316 points qui n'ont jamais transité par Seb — la Part a repris sa mise trois siècles après)**, la chose de la tranchée (412), et **ce dans quoi on taillait les pierres de mesure du palier I (6 812)**. **Ne pas expliquer ce que ça change.**
- **✅ LE NOM EST LIVRÉ — sc. 183, M1, sur la route rouge.** Seb a ouvert le Masque en grand devant **Firmin**, charretier à 340, qui est descendu de son banc, a fait le geste des jureurs et a chanté à genoux le dernier couplet que les grand-mères ne chantent qu'à couvert. **La bête a dit le nom en même temps que lui.** Canon, errata §1.1. Conduite : « la bête » reste l'usage courant ; **Aubran** ne se prononce que quand quelqu'un a une raison de le prononcer, et **jamais dehors** sans le savoir.
- **Ce que Firmin a donné en plus** *(canon)* : ce monde a un mot pour l'homme qui marche avec une de ces choses — **un jureur** — et la chanson dit que les jureurs **n'ont jamais fini par mourir**. *(Ce que ça veut dire : non fixé publiquement. Ne pas expliquer. C'est vrai, cf. §3 : Victor a été éjecté, pas tué.)*
- **TRAJECTOIRE DE FORME — errata §34 (validé joueur, 2026-08-13).** Elle monte vers une **femme anthropomorphe achevée avec qui Seb converse**, en six crans (debout ✅ · les mains · la face · la phrase · la question · la conversation), gagnés à la grosse prise ou à la réclusion, sur ce palier. **Son registre animal viendra de sa plus grosse prise du Murim : ce que Seb lui donne décide de ce qu'elle devient.** En face de lui : **alliée** — elle veut ce qu'il veut et le défend — **sauf sur la part**, qui reste sa créance et sur laquelle seule elle discute et peut refuser. **Elle règle ce qu'on voit d'elle**, comme lui règle son chiffre.
  - *Note MJ : le nom est ancien et masculin, la forme est féminine. **Ne jamais l'expliquer, ne jamais s'en excuser.** Un dieu prend la forme qu'il compose ; celle-ci est composée de ses victoires.*
  - *Note MJ : cette trajectoire **sert** le §7 et ne le change pas d'un mot. Une interlocutrice rend le dernier partage infiniment plus dur. **Ne rien toucher au §7.***
- État antérieur : **elle n'a plus faim depuis le J128** — elle a mangé son premier trophée, puis un garde. C'est la première fois en trois siècles. **Ne pas expliquer ce que ça change.**
...
- Plan B *(semi-fixe)* : une autre du sang existe au Fond — **⟦SCELLE-9⟧, 11 ans**. Ne révéler ni tôt ni gratuitement.

## 3 · LE FONDATEUR : **VICTOR** *(fixe)*

- Il y a trois siècles, Aubran choisit un porteur de charbon du lit de rivière : **Victor**. ⟦SCELLE-2⟧ fulgurante, fondation de **l'Ordre du Creuset** — la secte qui deviendra le Verger Blanc.
...
- Pourquoi détourne-t-on une rivière ? **Pour noyer quelque chose.** Sous le lit sec : la **première salle** de l'Ordre du Creuset, noyée lors de l'effacement. Aubran y a dormi trois siècles.
- La lignée ne s'est pas retrouvée là par hasard : Aubran l'a **aimantée** sur le lit sec, génération après génération.
...
- **« Aubran »** ne survit nulle part sur Terre. Au **Murim (palier II)**, son nom est dans ce qu'on chante des choses d'avant — **et il a été livré à la scène 183.** *(Errata §1.1 : nom définitif fixé ; le nom brûlé reste interdit à jamais.)*

## 7 · LA DESTINATION FINALE *(fixe — le sceau de la campagne)*

Au sommet — palier X, quand il n'existe **plus rien à vaincre** — la Part du ⟦SCELLE-13⟧ exige son dernier partage. Aubran aura récupéré forme, voix et nom ; Seb aura tout pris au monde. Il ne restera qu'eux : **les deux derniers convives**. **Le champion dévore le dieu, ou le dieu reprend tout ce que le champion a jamais pris.**
...
- **Ordre des révélations — état au 2026-08-13 :** salle noyée ✅ · Rayeurs ✅ (sc. 100) · **Maud / l'édit ✅ (sc. 138-145)** · **« Victor » ✅ (sc. 148)** · **« creuset » ✅ (sc. 148)** · **« Aubran » ✅ (sc. 183, par Firmin)** · destination → **scellée, et elle le reste : la chanson s'arrête avant.** **Prochain jalon de la bête : la phrase complète.**
...
- **Berthe → la lignée** : sa « chose » due peut router vers la famille (elle peut connaître ⟦SCELLE-9⟧, §2). **Toujours pas réclamée.**
...
- **La grosse pièce est un sommet de plaisir.** Dit de sa bouche le 2026-08-13 : *« la bête à 4xx était un des meilleurs passages de toute l'histoire jusqu'à présent. »* Une proie unique, terrée, qui rend coup pour coup et qui coûte des côtes, vaut mieux que dix scènes sociales. **En resservir, à la hauteur du chiffre du moment** — et se rappeler que ce jour-là il a payé quatre côtes et une jambe ouverte jusqu'à l'os sans se plaindre une seule fois.
- **Il ne joue pas aux énigmes.** Recadrage du 2026-08-13 (errata §31), dit deux fois : *« je suis perdu, je ne sais pas comment progresser »*, puis *« des pouces dans des pouces avec des creux, une langue morte à déchiffrer depuis trop de scènes — c'est trop abstrait, ce n'est pas marrant. »* **Il joue la domination et la prise, pas la résolution.** Une révélation ne vaut que par ce qu'elle change dans une scène qui mord. **Ne jamais construire un système à faire fonctionner par le joueur.**
- **Il surveille le bridage.** Recadrage du 2026-08-13 (errata §29) : le MJ avait fait apparaître un plafond de palier non écrit, juste au moment où il devenait trop fort. Il l'a vu immédiatement et l'a cité contre le §2.2. **Toute contrainte qui apparaît dans une fiche doit venir du canon, pas du confort du MJ** — il vérifie, et il a raison de vérifier.
