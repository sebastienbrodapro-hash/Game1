...
- **Scène courante : 142 EN COURS (LE PREMIER PRIX) — au comptoir des changes du bourg d'arrivée.** Estimation de la matière d'apex : jet 90-100 + TRIOMPHE naturel — Honorine (comptoir) a ouvert à l'insulte (3 mailles la plaque), puis **un acheteur du Pic de Fer (sans nom, ~11 000 poussière) a reconnu le fer d'orage et posé 40 taels la plaque, les soixante** (~2 400 taels — la source noire n'en rend plus depuis deux ans). **⚑ CRÉANCIER montée 3/4 → 4/4** (porte due servie : le jeu d'un comptoir se lit à livre ouvert). **Bloc en attente** : 1. vendre les 60 au forgeron à son prix (`marchandage`) · 2. laisser Maille mener l'enchère forge/comptoir [Chiffré] (`bete` `marchandage`) · 3. vendre une part, garder le reste (`marchandage`) · 4. demander à la forge autre chose que l'argent (`equipement` `marchandage`).
