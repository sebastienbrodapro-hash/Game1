...
Codex-010 : 184 491 → codex-011 : **184 491** (le cœur du Sanglier rendu au fond — jamais compté : c'était le tribut). **Contre l'étage servi** : le Sanglier ~100 000 pris à l'écrasement ✔ ; restent à l'ouest la Dame (~140 000) et le Dormant (200 000+) ; à l'est le patriarche (~90 000) et la couche haute (§18). **Ratio dans la fenêtre — rien ne sonne.** Les moyens : col de l'Étain (+1 600 p à encaisser), concessions de fer (4/10), couenne 400 kg, Gorgée +172 000 dormants.

## FICHE — Seb, 18 ans · sommet révélé aux deux bouts de la Traverse · SANS UNE DETTE NULLE PART

- `chiffre — 184 491 · pesé en entier par la Balance d'Avant (secret aux murs de la maison, loi de pesée)` · brassard CENDRE *(l'or du vallon au coffre — légal partout)*
- `CORPS 3/4 — LE GRÈS` · `jetons 4/10` · ⛔ **LA MAIN DE L'HIVER** *(permanent — toucher fin de la gauche mort ; deux mains fines = une bande plus dure ; froid vif = −5 art ; chair au JADE un jour)* · le pouce marqué
- **L'ART** : ⟨FIL⟩ 6/6 LA MARIONNETTE · ⟨FIL DE BRUME⟩ · LA BÉNÉDICTION DE LA TRAME *(la Balance a refusé de la peser : « il est d'avant elle »)*
