...
- **`releve-etat`** (Sonnet 5) — lancé **juste après chaque choix du joueur**, en arrière-plan ; sa ligne sert le **bloc suivant**. *(Cadence corrigée le 2026-08-14, option A du joueur : « avant chaque bloc » au sens strict imposait ~9 minutes d'attente par bloc, donc le MJ écrivait sans l'attendre — six fois de suite. Une ligne d'état vaut plusieurs scènes ; décalée d'un bloc elle reste vraie et ne coûte rien au rythme.)* Rend une ligne : portes applicables, dettes vives, promesses, horloges. Vise la faute « porte due non servie ». **Ne propose jamais d'option.**
