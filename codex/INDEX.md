...
| codex-004 | (ce commit) | 2026-08-10 | **Le Creuset (Seb)** | **v4 — fiction remise à zéro : reprise au tout début (veille de la pesée, rien joué).** Masque conservé ; §0.1 résumé en clair ; §1.8 cloison MJ/joueur ; `codex/MJ-ERRATA.md` créé (nom scellé brûlé) |
