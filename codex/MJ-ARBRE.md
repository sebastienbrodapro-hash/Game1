...
- **Cibles** : Terre a consommé **181 scènes** (cible 130-150 : dépassement de 30, cause identifiée — les huit scènes de déchiffrement et la course administrative, erratas §31/§31.3). **Paliers suivants : 50-70 scènes.** Tenir le budget cette fois.
- **Audit décennal silencieux** toutes les ~10 scènes. *Prochain : vers sc. 190.*
- **Règle de vitalité issue de Terre : quand le joueur dit qu'il est perdu, on coupe — trois faits, deux directions, on joue.**

---

## 1 · TRONC

→ Coffre : destination finale §7 · jalons fixes §3 (**Victor, paliers IV-VI, intact**) · ordre des révélations §9 · §6 (le nom, ici).

**Ordre des révélations — état** : salle noyée ✅ · Rayeurs ✅ · Maud/l'édit ✅ · « Victor » ✅ · « creuset » ✅ · **le nom de la bête → À LIVRER SUR CE PALIER**, par une bouche, dans un moment qui mord (errata §1 et §31) · destination finale → scellée.

## 2 · PALIER I — LA TERRE (sc. 1-181) — CLOS

Fini sur une plaine de terre battue devant Pierregarde : **6 812 abattu devant huit mille témoins, 10 206, débordement.**

**Ce qui reste derrière lui** *(vivant, jamais à rouvrir sans raison forte)* : l'Ordre du Creuset et 470 personnes sous Aude · **Margot**, qui tient les livres et à qui il a tout confié · **Jeanne**, à Clairefont, qui a demandé qu'il revienne et à qui il n'a pas dit au revoir · Anselme, le Cygne, Armand, Berthe et sa dette jamais réclamée, Gilles et son refus tenu, Odile · la fosse, l'écurie, les neuf plaques, le bloc brut resté à Pierregarde.
...
## 3 · PALIER II — LE MURIM : ÉTAT D'ENTRÉE

1. **10 206 dans un monde dont le sommet visible fait 4 000.** Il est au-dessus de tout. **Ne pas gonfler l'opposition** : ce qui résiste, ce sont les arts, les poisons, les formations, le nombre organisé, et surtout **le fait qu'il n'est personne ici** (MONDE §9.3).
...
- **§31 est la règle numéro un** : aucune scène dont le seul enjeu est de comprendre. Aucune énigme cumulative, aucune administration, **aucun calendrier compliqué**. Le MJ vérifie ses distances avant d'écrire une option.
- **Le webtoon, c'est du rythme** : prises spectaculaires, montées lisibles, transformations visibles, gens qui plient. Pas de contemplation.
- **La bête se livre par des bouches**, jamais par déchiffrement. Un mot par scène majeure maximum, toujours comptable.
- **Équipement : en servir vraiment.** Le joueur l'a réclamé. Mais rien qui monte de cran tout seul.
- **La dîme mord à chaque prise**, sans jamais être annoncée. Refuser déplace la note sur le compte ouvert le plus proche — **et ici, ses comptes ouverts sont vides : il n'a personne.** Première fois depuis J111. Faire découvrir ça en scène, pas en fiche.
- **Ligne tenue** : Seb a quinze ans.
- **Bloc entier, une fois** (§20), **4 options** (§26), **un jet par action** (§25), **porte due à chaque critique** (§27).