...
> **À jour au 2026-08-14 — v22, PALIER II v2, arrivée à jouer (sc. 209). La v1 du Murim est annulée — errata §39.**
...
## 1 · PALIER II v1 — ANNULÉ *(errata §39)*

**Vingt-sept scènes (182-208), du val de la Braise Haute aux abords de Vermeil — rembobinées le 2026-08-14 sur décision du joueur** : familiers absents du monde, réflexe de consignation hérité de Terre. Le détail reste dans `codex-018`, `codex-019`, `codex-020` et l'archive v21 (`codex-020.md`).
**Ces événements n'ont pas eu lieu. Ne pas les rejouer, ne pas y faire allusion en scène.** Visages et lieux en réserve : registre `MJ-CASTING` §0.0.

## 2 · PALIER II v2 — À JOUER

**Point mort : le débordement l'emporte hors de Terre. Où il retombe : première scène à écrire (sc. 209).** Point d'entrée neuf — pas la route rouge.
...
## 4 · HORS CHAMP — CE QUI CONTINUE SUR TERRE
